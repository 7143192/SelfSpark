...
private[spark] class DAGScheduler(
  ...
  private def eagerlyComputePartitionsForRddAndAncestors(rdd: RDD[_]): Unit = {
    ...
    logInfo("eagerlyComputePartitionsForRddAndAncestors for RDD %d took %f seconds"
  ...
  def runJob[T, U](
    ...
    print("submitJob in dagScheduler takes time = " + used0 + " ns\n")
    val start1 = System.nanoTime()
    ThreadUtils.awaitReady(waiter.completionFuture, Duration.Inf)
    val end1 = System.nanoTime()
    val used1 = end1 - start1
    print("ThreadUtils awaitReady takes time = " + used1 + " ns\n")
  ...
  private[scheduler] def handleJobSubmitted(jobId: Int,
    ...
    try {
      ...
      val end0 = System.nanoTime()
      val used0 = end0 - start0
      print("createResultStage in handleJobSubmitted takes time = " + used0 + " ns\n")
    } catch {
    ...
    val end1 = System.nanoTime()
    val used1 = end1 - start1
    print("submitStage takes time = " + used1 + " ns\n")
  }
    ...
    if (jobId.isDefined) {
      ...
      if (!waitingStages(stage) && !runningStages(stage) && !failedStages(stage)) {
        ...
        if (missing.isEmpty) {
          ...
          val end0 = System.nanoTime()
          val used0 = end0 - start0
          print("submitMissingTasks take time = " + used0 + " ns\n")
        } else {
          for (parent <- missing) {
            submitStage(parent)
          }
  ...
  private def submitMissingTasks(stage: Stage, jobId: Int): Unit = {
    ...
    stage match {
      ...
      case s: ResultStage =>
        ...
        val end0 = System.nanoTime()
        val used0 = end0 - start0
        print("outputCommitCoordinator stageStart takes time = " + used0 + " ns\n")
    }
    ...
    val end1 = System.nanoTime()
    val used1 = end1 - start1
    print("get task locations takes time = " + used1 + " ns\n")

    val start2 = System.nanoTime()
    stage.makeNewStageAttempt(partitionsToCompute.size, taskIdToLocations.values.toSeq)
    val end2 = System.nanoTime()
    val used2 = end2 - start2
    print("make new stage attempt takes time = " + used2 + " ns\n")
    ...
    try {
      ...
      RDDCheckpointData.synchronized {
        taskBinaryBytes = stage match {
          ...
          case stage: ResultStage =>
            val start2 = System.nanoTime()
            val serialized = closureSerializer.serialize((stage.rdd, stage.func): AnyRef)
            val end2 = System.nanoTime()
            val used2 = end2 - start2
            print("resultStage serialize stage info takes time = " + used2 + " ns\n")
            JavaUtils.bufferToArray(serialized)
        }
      ...
      val end1 = System.nanoTime()
      val used1 = end1 - start1
      print("RDDCheckpointData takes time = " + used1 + " ns\n")
    ...
    val used3 = end3 - start3
    print("produce all tasks takes time = " + used3 + " ns\n")
    ...
    if (tasks.nonEmpty) {
      ...
      val used4 = end4 - start4
      print("taskScheduler submitTasks takes time = " + used4 + " ns\n")
    } else {
