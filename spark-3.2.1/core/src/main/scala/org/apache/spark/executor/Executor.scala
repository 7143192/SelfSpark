...
private[spark] class Executor(
  ...
  def runTaskDirectly(context: ExecutorBackend, taskDescription: TaskDescription): Unit = {
    val tr = new TaskRunner(context, taskDescription, plugins, true)
  ...
  class TaskRunner(
    ...
    private var isFirstTask = isFirst
    ...
    override def run(): Unit = {
      ...
      try {
        ...
        print("thread get classLoader takes time = " + used0 + " ns\n")
        val start1 = System.nanoTime()
        task = ser.deserialize[Task[Any]](
          taskDescription.serializedTask, classLoader)
        val end1 = System.nanoTime()
        val used1 = end1 - start1
        print("deserialize to get task info takes time = " + used1 + " ns\n")
        ...
        print("metricsPoller onTaskStart takes time = " + used2 + " ns\n")
        taskStarted = true
        ...
        val value = Utils.tryWithSafeFinally {
          ...
          val used_1 = end_1 - start_1
          print("task.run for task " + taskId + " takes time = " + used_1 + " ns\n")
        ...
        val usedSerialTime = afterSerializationNs - beforeSerializationNs
        print("serialize result to get bytes takes time = " + usedSerialTime + " ns\n")
        ...
        val used_2 = end_2 - start_2
        print("serialize directResult takes time = " + used_2 + " ns\n")
        ...
        val end_3 = System.nanoTime()
        val used_3 = end_3 - start_3
        print("plugins onTaskSucceed takes time = " + used_3 + " ns\n")
