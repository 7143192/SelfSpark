...
class SparkContext(config: SparkConf) extends Logging {
  ...
  def runJob[T, U: ClassTag](
    ...
    print("clean one function in inner-most runJob takes time = " + used0 + " ns\n")
    ...
    print("dagScheduler runJob takes time = " + used1 + " ns\n")
    // progressBar.foreach(_.finishAll())
    val start2 = System.nanoTime()
    rdd.doCheckpoint()
    val end2 = System.nanoTime()
    val used2 = end2 - start2
    print("rdd doCheckPoint takes time = " + used2 + " ns\n")
  }
  ...
  def runJob[T, U: ClassTag](
    ...
    val end0 = System.nanoTime()
    val used0 = end0 - start0
    print("clean one function in runJob takes time = " + used0 + " ns\n")
  ...
  def runJob[T, U: ClassTag](rdd: RDD[T], func: Iterator[T] => U): Array[U] = {
    val res = runJob(rdd, func, 0 until rdd.partitions.length)
    res
  }
