...
object CodeGenerator extends Logging {
  ...
  var generatedClass: GeneratedClass = null
  var byteCodeStats: ByteCodeStats = null
...
//    if (!compiled) {
//      // (generatedClass, byteCodeStats) = doCompile(code)
//      doCompile_self(code)
//      compiled = true
//    }
...
//  }
  ...
  private[this] def doCompile_self(code: CodeAndComment): Unit = {
    ...
    generatedClass = evaluator.getClazz().
      getConstructor().newInstance().asInstanceOf[GeneratedClass]
  }
