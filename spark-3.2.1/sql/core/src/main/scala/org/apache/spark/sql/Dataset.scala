...
class Dataset[T] private[sql](
  ...
  */
  ...
  private def collectFromPlan(plan: SparkPlan): Array[T] = {
    ...
    print("createDeserializer takes time = " + used0 + " ns\n")
    val start1 = System.nanoTime()
    val collected = plan.executeCollect()
    val end1 = System.nanoTime()
    val used1 = end1 - start1
    print("plan.executeCollect takes time = " + used1 + " ns\n")
    val start2 = System.nanoTime()
    val res = collected.map(fromRow)
    val end2 = System.nanoTime()
    val used2 = end2 - start2
    print("map result takes time = " + used2 + " ns\n")
    res
  }
